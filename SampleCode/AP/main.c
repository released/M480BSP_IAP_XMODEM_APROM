...
//use excel to calculate , boot code : 64K (0x10000) , application : 128K  (0x20000) 
#define CHECKSUM_ADDRESS                                (0x2FFFC)
...
void TMR1_IRQHandler(void)
{
    ...
    if(TIMER_GetIntFlag(TIMER1) == 1)
    {
		...
		if ((get_tick() % 500) == 0)
		{
            FLAG_PROJ_TIMER_PERIOD_500MS = 1;//set_flag(flag_timer_period_1000ms ,ENABLE);
		}        
